    ...
    <View
      ...
      <View
        ...
        <Pic
          ...
          style={{marginRight: 4}}
        />
        <Text medium size={size || 14} color={BADGE[authorized].color}>
      ...
      {create ? (
        <TouchableOpacity
          style={[
            styles.border,
            {borderColor: '#AA0000', flexDirection: 'row'},
          ]}
          onPress={() => setCreate(!create)}>
          <Text medium size={size || 14} color={'#AA0000'}>
            Cancel
          </Text>
        </TouchableOpacity>
      ) : null}
      ...
      {add ? (
        <TouchableOpacity
          style={[
            styles.border,
            {borderColor: create ? '#148D00' : '#0083AC', flexDirection: 'row'},
          ]}
          onPress={() => {
            if (create) {
              if (tag != '') {
          ...
          <Text medium size={size || 14} color={create ? '#148D00' : '#0083AC'}>
            {create ? 'Create' : 'Add'}
          </Text>
        </TouchableOpacity>
      ) : null}
