      ...
      <View flex>
        <View row center middle>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              dispatch(closeBottomDrawerAction('Job Info'));
            }}>
        ...
        <ScrollView style={{height: '100%'}}>
          ...
          <View paddingHorizontal={20} row>
            <Text bold size={18}>
              {!isApplicant ? 'Current Employees:' : 'Applicants:'}
            </Text>
              ...
              <Table
                ...
                renderItem={({item}, index) => (
                  <TouchableOpacity
                    ...
                    <View flex middle>
                      <Pic
                        src={require('../assets/icons/profile/job_icons/remove.png')}
                        scale={23}
                      />
                    </View>
                  </TouchableOpacity>
              ...
              <Table
                ...
                renderItem={({item}, index) => (
                  <TouchableOpacity
                    ...
                    <View flex={1.3}>
                      <Text gray>{item.applicant_name}</Text>
                    </View>
                  </TouchableOpacity>
                )}
              />
